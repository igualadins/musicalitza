...
<?php if ($userLoggedIn) { // Si l'usuari ha fet login mostrem el panell d'usuari 
    $friendsObj = new Friends($dbConnection,$userLoggedIn); 
    //echo "valor $userLoggedIn hola";?>
              ...
              <div class="userPanelSectionBox">
                ...
                <div id="els-meus-amics-aceptats-list">
                    ...
                    <ul class="list-group" id="group_accepted">
                        ...
                        //$max = sizeof($userAcceptedFriends);
                        //echo "valor $max coi";
                            ...
                            <li class="list-group-item" id="accept<?php echo "{$friend['friendId']}";?>">
                                ...
                                <?php echo "{$friend['nom']}";?>  
                                 <div class="pull-right action-buttons">                                                                        
                                    <button class="btn btn-envelope" type="button" onclick="xat('<?php echo "{$friend['friendId']}";?>')">
                ...
                <div id="els-meus-amics-pendents-list">
                    <h2>Pendents</h2>
                    <!-- //// -->
                            ...
                            <li class="list-group-item" id="pendent<?php echo "{$friend['friendId']}";?>">
                                ...
                                <?php echo "{$friend['nom']}";?>
                                 <div class="pull-right action-buttons">
                                    ...
                                    <button class="btn btn-lock" type="button" onclick="bloquejarPendent('<?php echo "{$userLoggedIn}";?>','<?php echo "{$friend['friendId']}";?>','<?php echo "{$friend['imagen']}";?>','<?php echo "{$friend['nom']}";?>')">
                                        <i class="glyphicon glyphicon-lock"></i>
                                    </button>
